(() => {
  ...
  // Urdu translations per page (CSS selector → text/HTML)
  const UR = {
    // ---------- index.html ----------
    index: {
    ...
    techniques: {
      ...
      ".cards.two .card:nth-of-type(1) li:nth-of-type(3)": "روٹین درکار (مثلاً ہر 6 گھنٹے بعد مختصر چیک)۔",
    ...
    guide: {
      ...
      ".cards.two .card:nth-of-type(1) li:nth-of-type(4)":
        "<strong>درجۂ حرارت</strong> — گرمی/ٹھنڈ کو شیڈ/انڈور یا سن لائٹ سے مینج کریں۔",
      ".cards.two .card:nth-of-type(1) li:nth-of-type(5)":
        "<strong>نمی</strong> — بڑھانے کو سپرے، کم کرنے کو ڈیہیومیڈیفائی۔",
      ".cards.two .card:nth-of-type(1) li:nth-of-type(6)":
        "<strong>روشنی کے گھنٹے</strong> — سورج + گرو لائٹ سے روزانہ ضرورت پوری کریں۔",
  ...
  // Store original HTML for each selector so English can be restored
  const ORIGINAL = {};
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const selectors = Object.keys(UR[page] || {});
    saveOriginal(selectors);
